...
class Generator():
    ...
    def __init__(self):
      ...
      self.anchors = [(u/300.0,v/300.0) for u,v in anchors]
      self.last = "data"
  ...
  prior_box_param {
    ...
    def mbox(self, bottom, num):
       ...
       if self.first_prior:
           ...
           self.mbox_prior(bottom, min_size, max_size, [])
       else:
...
"""layer {
    ...
    def generate(self, stage, gen_ssd, size, class_num):
      ...
      if gen_ssd is True:
          ...
          self.mbox("conv11", 2) #3
          self.mbox("conv13", 2) #6
          self.mbox("conv14_2", 2) #6
          self.mbox("conv15_2", 2) #6
          self.mbox("conv16_2", 2) #6
          self.mbox("conv17_2", 2) #6
